...
ScrollReveal().reveal('.scroll-right-2', {origin: 'right', distance: '40px', duration: 1000, delay: 800 });
ScrollReveal().reveal('.scroll-right-3', {origin: 'right', distance: '40px', duration: 1000, delay: 1000 });
